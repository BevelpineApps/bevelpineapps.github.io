...
**Email: [bevelpine.support@proton.me](mailto:bevelpine.support@proton.me)**

Support hours are **Monday to Friday, 09:00&ndash;17:00 BST**. We aim to reply
within **2 business days**.

## Report a bug

Email the address above and include:

- **which app** you are using, and whether it is Jira or Confluence;
...
Same address. Tell us the problem you are trying to solve rather than the feature
you have in mind; it usually leads somewhere better.

## Track known issues

Each app's documentation page carries a **Limits and known issues** section that
we keep current:
...
we would rather tell you than leave you looking for one.

## Security issues

Please report anything security-related to the same address and put "security" in
the subject. See [Security](/security/) for how each app handles data.

## Questions

You can also ask on the [Atlassian Community](https://community.atlassian.com/).
